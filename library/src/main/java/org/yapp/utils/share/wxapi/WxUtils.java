...
/**
 * Description: 微信相关处理工具包. <br>
 * Date: 2016/8/27 11:21 <br>
 * Author: ysj
 */
public class WxUtils {
    private static final String TAG = "WxUtils";

    public static WXMediaMessage genMsg(WXMediaMessage.IMediaObject mediaObject, String description, String title) {
        return genMsg(mediaObject, description, title, null);
    }
